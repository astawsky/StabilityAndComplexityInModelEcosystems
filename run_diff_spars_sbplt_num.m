function run_diff_spars_sbplt_num(number_of_species,k,h,J,endtime_value_h,endtime_value_J,dense)
% k is the plot index
format long
rng(5)
density=dense;
